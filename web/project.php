...
<div class="vimeo-container">
	<div id="overlay" style="background-image: url(/img/<?php echo str_replace(' ','-',$objProject->title); ?>-cover.jpg); background-size: cover;"></div>
...
<?php echo $objProject->description; ?>
